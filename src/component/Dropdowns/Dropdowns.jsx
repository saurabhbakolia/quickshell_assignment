...
const Dropdowns = ({ grouping, ordering, setOrdering, setGrouping }) => {
    ...
    <div className="display-dropdown" ref={componentRef}>
      <div className="dropdown-label-container" onClick={openDropdown}>
        <div className="dropdown-label">
          <img src={`${process.env.PUBLIC_URL}/assets/icons/Display.svg`} />
          Display
          <img src={`${process.env.PUBLIC_URL}/assets/icons/down.svg`} />
        </div>
